...
import { loadSummary, loadDownloaders, type PluginApi, type SummaryPayload } from '../config/api'
              ...
              <div class="sae-field-section__rows">
                ...
                >
                  ...
                  <div class="sae-field-control">
                    ...
                    />
                    <VSelect
                      v-else-if="field.group === 'downloader'"
                      v-model="draft[field.key]"
                      :aria-label="field.label"
                      density="compact"
                      hide-details
                      item-title="title"
                      item-value="value"
                      :items="[{ title: '使用默认下载器', value: '' }, ...downloaderOptions]"
                      variant="outlined"
                    />
                    <VSelect
