...
async function loadDownloaders(api) {
  ...
  try {
    ...
    console.warn("[SubscribeAssistantEnhanced] downloaders unavailable");
    return null;
  }
}
...
const fields = [
  ...
  {
    "key": "best_version_downloader",
    "label": "洗版下载器",
    "group": "bestVersion",
    "kind": "select",
    "hint": "指定洗版任务使用的专用下载器，为空则使用默认下载器"
  },
  {
...
const englishFields = {
  ...
  best_version_downloader: ["Best-version downloader", "Specify a dedicated downloader for upgrade tasks; leave empty for the default downloader"],
                        ...
                        return _openBlock(), _createElementBlock("div", {
                          ...
                          _createElementVNode("div", _hoisted_22, [
                            field.key === "reset_task" ? (_openBlock(), _createBlock(_component_VCheckbox, {
                              ...
                              density: "compact",
                              "hide-details": ""
                            }, null, 8, ["id", "modelValue", "onUpdate:modelValue", "aria-label"])) : field.key === "best_version_downloader" ? (_openBlock(), _createBlock(_component_VSelect, {
                              key: 2,
                              modelValue: _unref(draft)[field.key],
...
const Config = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6f5b72fd"]]);
